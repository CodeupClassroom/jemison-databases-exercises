...
SELECT roles.name
FROM roles # has 4 rows of data in the original table, but output has 5 rows. Why? To show all relevant relationships, values from the original table had to be duplicated
